...
async function deploy() {
  ...
  console.log('Login successful. Uploading Kafka Rule Chain...');

  const ruleChainData = JSON.parse(fs.readFileSync('device_created_kafka_rule_chain.json', 'utf8'));
  ...
  console.log('Kafka Rule Chain metadata saved successfully!');
}
